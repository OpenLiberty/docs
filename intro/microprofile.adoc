...
Try it now: Explore how to manage the impact of failures by using MicroProfile Fault Tolerance in our guide to link:/guides/microprofile-fallback[Building fault-tolerant microservices with the @Fallback annotation].

Learn how to use MicroProfile's Timeout and Retry policies in our guide to link:/guides/retry-timeout[Failing fast and recovering from errors].

Discover how to create a fault-tolerant microservice in our guide to link:/guides/circuit-breaker[Preventing repeated failed calls to microservices].

Explore how to limit requests and prevent faults from cascading to the entire system in our guide to link:/guides/bulkhead[Limiting the number of concurrent requests to microservices].
...
Try it now: Learn how to provide external configuration to microservices using MicroProfile Config in our guide to link:/guides/microprofile-config[Configuring microservices].

Discover how to perform static configuration injection using MicroProfile Config in our guide to link:/guides/microprofile-config-intro[Separating configuration from code in microservices].
...
Try it now: Explore how to report and check the health of a microservice with MicroProfile Health in our guide to link:/guides/microprofile-health[Adding health reports to microservices].
...
in our guide to link:/guides/kubernetes-microprofile-health[Checking the health of microservices on Kubernetes].
