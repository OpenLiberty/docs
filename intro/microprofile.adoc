...
*Try it out:* Learn how to create a REST service with JAX-RS, JSON-P, and Open Liberty in our interactive guide to link:/guides/rest-intro[Creating a RESTful web service].
...
*Try it out:* Learn how to use MicroProfile Rest Client to invoke RESTful microservices over HTTP in a type-safe way in our interactive guide to link:/guides/microprofile-rest-client[Consuming RESTful services with template interfaces].
...
*Try it out:* Explore how to document and filter RESTful APIs by using MicroProfile OpenAPI in our interactive guide to link:/guides/microprofile-openapi[Documenting RESTful APIs].
...
*Try it out:* Explore how to manage the impact of failures by using MicroProfile Fault Tolerance in our interactive guide to link:/guides/microprofile-fallback[Building fault-tolerant microservices with the @Fallback annotation].
...
*Try it out:* Explore how to control user and role access to microservices with MicroProfile JWT in our interactive guide to link:/guides/microprofile-jwt[Securing microservices with JSON Web Tokens].
...
*Try it out:* Learn how to provide external configuration to microservices using MicroProfile Config in our interactive guide to link:/guides/microprofile-config[Configuring microservices].
...
*Try it out:* Explore how to report and check the health of a microservice with MicroProfile Health in our interactive guide to link:/guides/microprofile-health[Adding health reports to microservices].
...
*Try it out:* Explore how to provide system and application metrics from a microservice with MicroProfile Metrics in our interactive guide to link:/guides/microprofile-metrics[Providing metrics from a microservice].
...
*Try it out:* Explore how to enable and customize tracing of JAX-RS and non-JAX-RS methods by using MicroProfile OpenTracing in our interactive guide to link:/guides/microprofile-opentracing[Enabling distributed tracing in microservices].
