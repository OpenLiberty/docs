...
MicroProfile Metrics 2.3 explicitly enables the link:https://openliberty.io/docs/ref/feature/#monitor-1.0.html[Performance Monitoring 1.0 feature]. If you use earlier than version 2.3 of the MicroProfile Metrics feature, then you must also enable the Performance Monitoring 1.0 feature.
...
|base_REST_request_total{class="<fully_qualified_class_name>",method="<method_signature>"}
 base_REST_request_elapsedTime_seconds{class="<fully_qualified_class_name>",method="<method_signature>"}
|SimpleTimer
