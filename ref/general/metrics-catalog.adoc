...
:page-type: general
:base-metric-features: feature:mpMetrics-2.2[]
:vendor-metric-features: feature:mpMetrics-2.2[] and feature:monitor-1.0[]
:ft-metric-features: feature:mpMetrics-2.2[], feature:monitor-1.0[], and feature:mpFaultTolerance-2.0[]
...
Some metric names changed between MicroProfile Metrics 1.1 and MicroProfile Metrics 2.x. Go to the link:/docs/ref/general/#metrics1.1-list.html[MicroProfile Metrics 1.1 reference list] if you need to map feature:mpMetrics-2.2[] metric information to feature:mpMetrics-1.1[] metric information.
