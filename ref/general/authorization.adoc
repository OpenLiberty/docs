...
The roles against which users and groups are checked can be either be defined in the application or applied to the application by way of the server configuration.
