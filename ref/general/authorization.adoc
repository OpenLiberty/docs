...
The roles that users and groups are checked against can be either be defined in the application or applied to the application by way of the server configuration.
