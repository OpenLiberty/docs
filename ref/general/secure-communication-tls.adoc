...
Through this process, the client and server agree on the version of the TLS protocol to use, select cryptographic algorithms (CypherSuites), and authenticate one another by exchanging and verifying digital certificates.
