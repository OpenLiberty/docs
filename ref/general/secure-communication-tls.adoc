...
Through this process, client and server agree on a version of the TLS protocol, select cryptographic algorithms that are called CypherSuites, and authenticate one another by exchanging and verifying digital certificates.
