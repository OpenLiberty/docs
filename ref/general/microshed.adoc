...
By using the generated ID, invoke an HTTP GET request to read the record created. The JSON response automatically converts to a 'Person' object using JSON-B.
