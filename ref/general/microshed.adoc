...
The @Test annotation invokes an HTTP GET request to get a person with ID `-1`, which does not exist and asserts that the application container returns an HTTP 404 (not found) exception.
