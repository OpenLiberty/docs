...
link:https://microshed.org/microshed-testing/[MicroShed Testing] analyzes your application from outside the container without accessing the application internally.
