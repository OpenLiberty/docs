...
You can easily see repository and proxy settings that are contained in the `featureUtility.properties` file by running the link:/docs/ref/general/#featureUtility-viewSettings.html[`featureUtility viewSettings` command].
