...
-- Social Media Login: Request log in with a social media ID for only a subset of applications, URLs, browsers, or IP addresses
-- Simple and Protected GSSAPI Negotiation Mechanism (SPNEGO): Limit SPNEGO authentication
