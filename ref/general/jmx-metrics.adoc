...
You can use the `ConnectionPool` MXBean for monitoring the connection pool in Open Liberty.
...
|`getAttribute("WebSphere:type=SipContainerBasicCounters,name=SipContainer.Basic", "ReceivedSipMsgs")`
|Not applicable
|Server
...
{empty} +
{empty} +
The average number of new SIP application sessions created in the container and calculated over a configurable period.	|`getAttribute("WebSphere:type=SipContainerBasicCounters,name=SipContainer.Basic", "NewSipApplications")`
|Not applicable
|Server
...
|`getAttribute("WebSphere:type=SipContainerBasicCounters,name=SipContainer.Basic", "SipAppSessions")`
|Not applicable
|Server
...
|`getAttribute("WebSphere:type=SipContainerBasicCounters,name=SipContainer.Basic", "SipSessions")`
|Not applicable
|Server
...
|`getAttribute("WebSphere:type=SipContainerBasicCounters,name=SipContainer.Basic", "InvokerSize")`
|Not applicable
|Server
...
|`getAttribute("WebSphere:type=SipContainerBasicCounters,name=SipContainer.Basic", "RejectedMessages")`
|Not applicable
|Server
...
|`getAttribute("WebSphere:type=SipContainerBasicCounters,name=SipContainer.Basic", "SipRequestProcessing")`
|Not applicable
|Server
...
|`getAttribute("WebSphere:type=SipContainerBasicCounters,name=SipContainer.Basic", "SipTimersInvocations")`
|Not applicable
|Server
