...
* MicroProfile Fault Tolerance 2.0 contains changes that can cause an application that is written for an earlier version to fail when it uses the 2.0 feature. For more information, see link:/docs/ref/general/#fault-tolerance-1-dif.html[Differences between MicroProfile Fault Tolerance 1.0 and 2.0].
