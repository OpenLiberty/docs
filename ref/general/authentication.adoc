...
With SPNEGO SSO, users log in to the Microsoft[TM] domain controller one time to access and move between protected resources on Open Liberty servers.
...
Open Liberty contains a number of built-in login contexts and login modules. You can also configure modules and contexts to customize authentication.
