...
passwords in this example have been obfuscated by hashing. In order to keep your basic registry secure, link:#passwords[never store your passwords in plain text].
[source, java]
----
