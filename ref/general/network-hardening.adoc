...
For supported mode, set the link:/docs/ref/config/#ssl.html[`clientAuthenticationSupported` attribute] to the value of `true` in your TLS configuration.
...
For required mode, set the link:/docs/ref/config/#ssl.html[`clientAuthentication` attribute] to the value of `true` in your TLS configuration.
