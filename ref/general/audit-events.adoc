...
* <<SECURITY_AUDIT_MGMT, SECURITY_AUDIT_MGMT>>
...
* Servlet 3.0 APIs: <<SECURITY_API_AUTHN, SECURITY_API_AUTHN>>/<<SECURITY_API_AUTHN_TERMINATE, SECURITY_API_AUTHN_TERMINATE>>/<<SECURITY_API_AUTHN, SECURITY_API_AUTHN>>
