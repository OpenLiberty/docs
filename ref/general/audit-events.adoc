...
* <<SECURITY_AUTHN, Basic authentication>>
* <<SECURITY_AUDIT_MGMT, Management of the audit service>>
* <<SECURITY_AUTHN, Form login authentication>>
* <<SECURITY_AUTHN, Client certificate authentication>>
* <<SECURITY_AUTHN_DELEGATION, Servlet runAs delegation>>
* <<SECURITY_AUTHN_FAILOVER, Failover to basic authentication>>
* <<SECURITY_AUTHZ, Unprotected servlet authorization>>
* Servlet 3.0 APIs: <<SECURITY_API_AUTHN, login>>/<<SECURITY_API_AUTHN_TERMINATE, logout>>/<<SECURITY_API_AUTHN, authenticate>>
* <<SECURITY_AUTHZ, JACC web authorization>>
* <<SECURITY_AUTHN, JASPI authentication>>
* << SECURITY_AUTHN_TERMINATE, Form logout>>
* <<SECURITY_AUTHZ, JACC EJB authorization>>
* <<SECURITY_AUTHN_DELEGATION, EJB delegation>>
* <<SECURITY_MEMBER_MGMT, SCIM operations/member management>>
* <<SECURITY_AUTHZ, EJB authorization>>
* <<JMX_MBEAN, JMX MBean operations>>
* <<JMS_MBEAN_NOTIFICATION, JMX Notifications>>
* <<JMX_MBEAN_REGISTER, JMX MBean registration>>
* <<JMX_MBEAN_ATTRIBUTES, JMX MBean attribute operations>>
* <<SECURITY_JMS_AUTHN, JMS Authentication>>
* <<SECURITY_JMS_AUTHZ, JMS Authorization>>
