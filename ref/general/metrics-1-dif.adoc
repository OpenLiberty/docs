...
:page-type: general
= Differences between MicroProfile Metrics 1.1 and 2.x

The link:/docs/ref/general/#metrics-list.html[metrics reference list] includes all the metrics that are available for Open Liberty.

Some metric names and types changed between MicroProfile Metrics 1.1 and MicroProfile Metrics 2.x, so the following table lists the link:/docs/ref/feature/#mpMetrics-2.3.html[MicroProfile Metrics 2.3] metric names and the corresponding link:/docs/ref/feature/#mpMetrics-1.1.html[MicroProfile Metrics 1.1] metric names. It also lists the corresponding Prometheus names and metric types:
{empty} +
