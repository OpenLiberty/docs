...
----
Open Liberty supports authentication filters for a variety of authentication mechanisms, including the following technologies:

* link:/docs/ref/feature/#jwtSso-1.0.html[JSON Web Tokens]
