...
A WAR file is a compressed archive file that contains an application and a `web.xml` file that tells Open Liberty how to run the application, in addition to other resources that your application needs.
...
----
include::/guide-getting-started/master/start/Dockerfile.adoc[]
----
...
You can build a WAR file that contains your application and its server configuration for deployment to an Open Liberty server.
