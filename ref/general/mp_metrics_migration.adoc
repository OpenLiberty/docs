...
The following example shows how GET and OPTIONS requests are used in MicroProfile Metrics 1.x:
...
The following example shows how GET and OPTIONS requests are used in MicroProfile Metrics 2.x:
