...
* link:link:/docs/ref/general/#configuring-spnego-auth.html[Simple and Protected GSSAPI Negotiation Mechanism (SPNEGO)]
* llink:/docs/ref/feature/#socialLogin-1.0.html[Social Media Login]
