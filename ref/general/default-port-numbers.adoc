 Request Timing feature// Copyright (c) 2019 IBM Corporation and others.
...
You can configure this port in the `bootstrap.properties` file. For more information, see link:https://openliberty.io/docs/ref/config/[Server Configuration overview].
...
<httpEndpoint id="defaultHttpEndpoint"
    ...
    httpsPort="9445" />
----
For more information about HTTP endpoints, see link:/docs/ref/config/#httpEndpoint.html[HTTP Endpoint].
...
----
For more information about WAS JMS endpoints, see link:/docs/ref/config/#wasJmsEndpoint.html[WAS JMS Endpoint].
