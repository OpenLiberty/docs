...
<httpEndpoint id="defaultHttpEndpoint"
    ...
    httpsPort="9445" />
----
For more information about HTTP endpoints, see link:https://draft-openlibertyio.mybluemix.net/docs/ref/config/#httpEndpoint.html[HTTP Endpoint (httpEndpoint)]
