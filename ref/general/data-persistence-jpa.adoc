...
The Java Persistence API (JPA) simplifies and standardizes data persistence and object relational mapping for Java applications. With JPA, applications can efficiently create, read, update, or delete objects from a relational database.
