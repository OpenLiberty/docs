...
For more information about specifying directory properties, see the <</docs/ref/config/serverConfiguration.adoc#variable-sub, Server configuration overview>>.
