...
For more information about specifying directory properties, see the <</docs/ref/config/serverConfiguration.html#variable-sub, Server configuration overview>>.
