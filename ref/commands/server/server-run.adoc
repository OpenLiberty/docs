...
The standard output and error from the server process are output to the foreground. To stop a server in the foreground, press CTRL + C in the terminal to end the process.
