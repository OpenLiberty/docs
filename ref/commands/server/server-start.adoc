...
Start the `myserver` server in the background and set the `variable1_name` variable to `variable1_value`:

----
server start myserver -- --variable1_name=variable1_value
----
