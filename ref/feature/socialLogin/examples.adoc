...
To further restrict users to those who are also in a configured registry, add the `mapToUserRegistry` attribute and use a registry such as config:ldapRegistry[]:
