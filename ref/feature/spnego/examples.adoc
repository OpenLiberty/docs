...
Specify attributes within the link:https://draft-openlibertyio.mybluemix.net/docs/ref/config/#authFilter.html[`<authFilter>` element] in the `server.xml` file to require SPNEGO authentication for certain requests:
