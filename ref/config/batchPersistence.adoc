...
|+It is recommended to use a container managed authentication alias instead of configuring this property.+
|===
[#+jobStore/dataSource/properties.oracle.ucp+]*jobStore > dataSource > properties.oracle.ucp*
...
|===
[#+jobStore/dataSource/properties.postgresql+]*jobStore > dataSource > properties.postgresql*
