...
|===
[#+httpEndpoint/compression/types+]*httpEndpoint > compression > types*
...
[#+httpEndpoint/samesite/lax+]*httpEndpoint > samesite > lax*
...
[#+httpEndpoint/samesite/none+]*httpEndpoint > samesite > none*
...
[#+httpEndpoint/samesite/strict+]*httpEndpoint > samesite > strict*
