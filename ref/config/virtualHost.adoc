...
|===
[#+allowFromEndpoint/compression/types+]*allowFromEndpoint > compression > types*
...
[#+allowFromEndpoint/samesite/lax+]*allowFromEndpoint > samesite > lax*
...
[#+allowFromEndpoint/samesite/none+]*allowFromEndpoint > samesite > none*
...
[#+allowFromEndpoint/samesite/strict+]*allowFromEndpoint > samesite > strict*
