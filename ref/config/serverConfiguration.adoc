...
If you start the server from a runnable JAR file, you can define variables in `variable_name=variable_value` format at the end of the command line:

----
java -jar myServer.jar HTTP_Port=9080 HTTPS_Port=9443
----
