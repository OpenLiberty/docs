...
When the maximum number of archived audit logs is reached, and the audit.log that is currently being written to reaches its maximum size, then the oldest archived audit log is overwritten.
