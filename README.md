 ...
 * `vNext`
 ...
 Each branch is protected and all pull requests require review from a either a [doc member](https://github.com/orgs/OpenLiberty/teams/docs-members) or [doc maintainer](https://github.com/orgs/OpenLiberty/teams/docs-maintainers/members). If you want to publish doc updates with the next OL release, your doc updates must be merged to the `vNext` branch by the Monday before the OL release. For example, if the OL release is Friday, 23 October 2020, then you must complete your doc updates and merge them to the `vNext` branch by Monday, 19 October 2020. The following sections provide further information about making doc updates and merging to the `vNext` branch. 
