...
The Open Liberty environment variables in the following list can be configured in the xref:reference:config/server-configuration-overview.adoc[server.env] file to customize the Liberty environment.
