...
Some metric names and types changed between MicroProfile Fault Tolerance 2.1 and MicroProfile Fault Tolerance 3.0. Some Prometheus metric names also changed between these versions. For more information, see xref:reference:metrics-1-dif.adoc#_fault[Differences between MicroProfile Fault Tolerance 2.1 and 3.0].
