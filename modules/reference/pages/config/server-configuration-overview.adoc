...
. `server.xml` file `defaultValues`
. environment variables
. `bootstrap.properties`
. Java system properties
. `server.xml` file variable values
. variables declared on the command line

// tag::variable-sub-intro[]
