...
[#exp-var-windows]
==== Expansion variables
Expansion variables are environment or shell variables which are replaced by their values. You can specify expansion variables in the value definition of other variables.
