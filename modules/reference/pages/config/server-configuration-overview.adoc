...
* All characters are literal except when expansion variables are enabled. For more information, see xref:reference:default-environment-variables.adoc[Default environment variables].
