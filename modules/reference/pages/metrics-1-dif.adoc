...
Some metric names and types changed between MicroProfile Metrics 1.1 and MicroProfile Metrics 2.x. The following table lists the xref:feature/mpMetrics-2.2.adoc[MicroProfile Metrics 2.2] metric names and the corresponding xref:feature/mpMetrics-1.1.adoc[MicroProfile Metrics 1.1] metric names. It also lists the corresponding Prometheus names and metric types for each MicroProfile Metrics version:
{empty} +
...
The following table lists the xref:feature/mpFaultTolerance-2.2.adoc[MicroProfile Fault Tolerance 2.1] metric names and the corresponding xref:feature/mpMetrics-1.1.adoc[MicroProfile Fault Tolerance 3.0] metric names. It also lists the corresponding Prometheus names and metric types for each MicroProfile Metrics version:
{empty} +

.Metrics changes from MicroProfile Fault Tolerance 2.1 to MicroProfile Fault Tolerance 3.0
[%header,cols="9,9,2,9,9,2"]
|===
