...
|Enables or disables the scanning and processing of Jakarta Validation annotations. The default value is `true`. This property is available in MicroProfile OpenAPI 3.1 and later.
|Application startup
