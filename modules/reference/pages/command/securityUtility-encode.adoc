...
* Encrypt a password with Advanced Encryption Standard (AES) encryption.  
...
* Hash a password.  
  After you enter this command, interactive mode prompts you for the password that you want to hash:
...
[NOTE]
====
The configuration file must contain either the `wlp.aes.encryption.key` or the
