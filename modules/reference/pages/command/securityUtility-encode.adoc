...
Encode with Base64 AES key

To encode a password by using a Base64-encoded AES key, specify the key directly:
...
Encode with AES key configuration file
...
[NOTE]
====
The configuration file must contain either the `wlp.aes.encryption.key` or 
