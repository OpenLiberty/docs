...
----
server run _serverName_ [options]
----
...
|3
|3 indicates an unsupported action was called on a running server. For example, the server is running when the package action is called.
