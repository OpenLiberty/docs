...
|>0
|>0 Exit codes that are greater than 0 indicate that an error occurred while performing the request. Messages are printed with more information about the error.
