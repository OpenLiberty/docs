...
The updated xref:command/auditUtility-auditReader.adoc[auditUtility] command does not read audit logs that were signed or encrypted before version 25.0.0.3. 
