...
You can use the `featureUtility installServerFeatures` commands to install both versioned and xref:reference:feature/versionless-features.adoc[versionless features].
