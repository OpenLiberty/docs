...
When FIPS 140-3 is enabled, set the system properties by using the following JVVM_ARGS environment variable to enable the 'securityUtility' tool to create LTPA keys with the 'createLTPAKeys' command:
