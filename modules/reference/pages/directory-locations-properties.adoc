...
For more information about file-based health checks, see xref:health-check-microservices.adoc#_microprofile_health_v4_0[file-based health check overview].
