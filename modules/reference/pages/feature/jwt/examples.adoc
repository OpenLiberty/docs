...
JWT consumers support signature algorithm validation for signed tokens. The process for configuring signature algorithm validation for JWT consumers is similar to the feature:openidConnectClient[display=OpenID Connect Client 1.0] feature.
