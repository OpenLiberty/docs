...
Otherwise, you must manually enable the Federated User Registry feature and specify the `federatedRepository` element to federate multiple LDAP registries.
