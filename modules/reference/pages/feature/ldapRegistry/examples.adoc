...
----
Use the LDAP registry for administrator role mapping. Add the ldapRegistry-3.0 feature to your 'server.xml' file.
The following example shows an LDAP registry that gives the user "bob" administrator role.
