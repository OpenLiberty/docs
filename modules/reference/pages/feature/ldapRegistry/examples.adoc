...
For more information, see the documentation for the configuration element for the LDAP type that you want to specify. The feature configuration elements for the available LDAP types are listed in the xref:ldapRegistry-3.0.adoc#_feature_configuration_elements[feature configuration elements section].
