...
You can configure different audit events that are captured and routed to OpenTelemetry by specifying the relevant audit events and outcomes in the config:auditFileHandler[] element. For more information, see the link:/docs/latest/reference/feature/audit-2.0.html#_configure_the_audit_events_to_log[Configure the audit events to log].
