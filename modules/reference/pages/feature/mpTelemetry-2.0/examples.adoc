...
You can configure different audit events that are captured and routed to OpenTelemetry by specifying the relevant audit events and outcomes in the `auditFileHandler` element. For more information, see the feature:audit[display=Audit] feature.
