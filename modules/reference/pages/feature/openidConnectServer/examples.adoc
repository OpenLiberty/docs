...
The example uses a simple xref:/docs/ref/feature/#appSecurity-3.0.adoc[basic registry], which is defined in the server configuration, to manage a single user:
...
If you use a database, replace the `localStore` section with xref:/docs/ref/feature/#jdbc-4.3.adoc[JDBC] database configuration.
