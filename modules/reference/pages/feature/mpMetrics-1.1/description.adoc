...
If you are updating your application from using MicroProfile Metrics 1.1 to using MicroProfile 2.0, changes in API behavior might require you to update your application code. For more information, see xref:ROOT:mp-21-22-diff.adoc#metrics[Differences between MicroProfile Metrics 2.0 and 1.1].
