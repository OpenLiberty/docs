...
The Eclipse Transformer transforms existing JavaEE features into their Jakarta EE equivalents. Currently, the transformer cannot update Open Liberty features because it is missing rules data to specify the updates.
...
* xref:jakarta-ee.adoc[Jakarta EE]
