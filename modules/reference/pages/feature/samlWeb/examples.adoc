...
You can disable the `defaultSP` service provider instance, and configure a new `newSP` service provider instance, if needed, by adding the following code to the `server.xml` file:
