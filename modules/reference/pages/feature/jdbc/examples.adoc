...
The following examples demonstrate common uses of the Java Database connectivity feature. For more information, see xref:ROOT:relational-database-connections-JDBC.adoc[Relational database connections with JDBC].
