...
You can customize how the JWT is built with the JSON Web Token Single Sign-On feature.
The following example shows how you can configure the JSON Web Token Single Sign-On feature to change the token expiration time:
...
The JSON Web Token Single Sign-On feature automatically uses the `mpJwt` element.
