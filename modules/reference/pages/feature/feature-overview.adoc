...
The Jakarta EE Web Profile feature enables only those features that are part of the Jakarta EE Web Profile. A list of all the features that a convenience features enables is provided on the reference page for each convenience feature.
...
feature:jakartaee[display=Jakarta EE Platform]::
This feature enables all features that are associated with the Jakarta EE platform.

feature:webProfile[display=Jakarta EE Web Profile]::
This feature enables only features that are associated with the lightweight link:https://jakarta.ee/specifications/webprofile/9/[Jakarta EE Web Profile].

feature:jakartaeeClient[display=Jakarta EE Application Client]::
This feature enables all features that are associated with Jakarta EE link:https://jakarta.ee/specifications/platform/9/jakarta-platform-spec-9.html#a3294[Application Client] functions.

Open Liberty also provides two additional convinience features.

* The feature:micropProfile[display=MicroProfile] convenience feature enables all the Open Liberty features that support the MicroProfile platform.
