...
* feature:jakartaee[display=Jakarta EE Platform]:: This feature enables all features that are associated with the Jakarta EE platform
* feature:webProfile[display=Jakarta EE Web Profile]:: This feature enables only features that are associated with the lightweight link:https://jakarta.ee/specifications/webprofile/9/[Jakarta EE Web Profile].
* feature: jakartaeeClient[display=Jakarta EE Application Client]:: This feature enables all features that are associated with Jakarta EE link:https://jakarta.ee/specifications/platform/9/jakarta-platform-spec-9.html#a3294[Application Client] functions.

Additionally, the feature:enterpriseBeans[Jakarta Enterprise Beans] convenience feature automatically enables all Open Liberty features that support enterprise beans functions.
