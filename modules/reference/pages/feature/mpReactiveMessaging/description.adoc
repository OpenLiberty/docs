You can use MicroProfile Config properties to provide configuration values for MicroProfile Reactive Messaging. For more information, see xref:microprofile-config-properties.adoc#react[MicroProfile Config Properties: Reactive Messaging].
