...
----
for administrative role mapping, you can use the basic registry.
...
----
To quickly configure a single administrator for testing and development purposes, you can use the 'quickStartSecurity' element . This option automatically configures a registry with only one user who is granted the administrator role.
