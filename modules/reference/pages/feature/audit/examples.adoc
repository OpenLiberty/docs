...
=== Send audit logs to the OpenTelemetry exporter

When the Audit feature is enabled together with the feature:mptelemetry[display=MicroProfile Telemetry] feature, you can collect and send audit logs to your configured OpenTelemetry exporter. For more information, see link:/docs/latest/reference/feature/mpTelemetry-2.0.html#logs[MicroProfile Telemetry: Collect logs from a specified source].
