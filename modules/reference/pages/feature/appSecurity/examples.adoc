...
----
For more information on LTPA configuration attributes, see the config:ltpa[display=LTPA] configuration element. For more information about LTPA best practices, including how to configure secure cookies that must use TLS, see xref:ROOT:network-hardening.adoc#ltpa[LTPA best practices].
