...
If you want to specify a realm for a user or group that you assign a role to, you can use the `user-access-id` or `group-access-id` elements, as shown in the following example:
----
<reader-role>
