...
Open Liberty creates a keystore password during profile creation and puts it in the `${server.config.dir}/server.env` file that is in the server home directory.
