...
You can use the `createSSLCertificate` command with the `securityUtility` command to create the default certificate.
...
|Password
|Password that is provided in the TLS configuration
