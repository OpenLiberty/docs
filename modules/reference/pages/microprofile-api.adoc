...
MicroProfile complements the Jakarta Platform, Enterprise Edition (Jakarta EE), and the Java Platform, Enterprise Edition, versions 7 and 8 (Java EE and Java EE 8), which Open Liberty also supports. For more information about MicroProfile, see xref:ROOT:microprofile.adoc[MicroProfile overview].
