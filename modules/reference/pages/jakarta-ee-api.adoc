...
Jakarta EE is an open source Java platform. Before Jakarta EE version 8, the platform was owned by the Oracle corporation and known as Java, Enterprise Edition (https://www.oracle.com/java/technologies/java-ee-glance.html[Java EE]). Open Liberty also supports Java EE versions 7 and 8. For Java EE API documentation, see xref:java-ee-api.adoc[Java EE API]. For more information about Java EE, Jakarta EE, and Open Liberty, see xref:ROOT:jakarta-ee.adoc[Jakarta EE overview]. For more information about transitioning your server from Java EE to Jakarta EE, see xref:ROOT:jakarta-ee9-feature-updates.adoc[Jakarta EE 9 feature updates].
