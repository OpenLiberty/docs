...
To get a list of application passwords or application tokens for the specified user, enter a username in the search field and hit Enter, ashsown in the following screen capture:
