...
----
+
. After you access the **Design** tab in the **Server Config** tool, select a resource in the configuration to see the enabled features and parameter settings. Click the **Test** button. 
+
