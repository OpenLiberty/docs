...
For information about packaging the JAR, see link:/docs/command/#server-package.html[server package].
...
For information about specifying environment variables, see link:/docs/config/[Server configuration].
...
* link:/docs/command/#server-package.html[server package]
