...
Refer to the sections on <<Specifying a DatabaseStore>> and <<Specifying an EclipseLink Persistence Unit Reference>> for information about how to control the table creation settings.
...
<featureManager>
  ...
  <feature>xmlBinding-4.0</feature> <!-- required by Hibernate -->
