...
The following example shows the basic configuration to specify JDBC vendor properties in the link:docs/latest/reference/config/dataSource.html#properties[properties] subelement:
