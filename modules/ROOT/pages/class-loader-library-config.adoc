...
If configure class loading override the default settings, you cannot deploy an application by dropping it into the `dropins` directory, unless you configure a <<Configure global libraries, global library>>.
