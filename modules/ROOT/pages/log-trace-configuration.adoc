...
When you specify these suffixes to add non-string values, the resulting JSON fields are not enclosed in quotes in the logs. Only string-valued JSON fields are enclosed in quotes in the logs.
