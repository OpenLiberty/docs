...
You can use MicroProfile Config with Open Liberty by enabling the [MicroProfile Config] feature or the [MicroProfile] feature in your `server.xml` file.
The MicroProfile feature is a convenience feature that enables all the core [MicroProfile] features for Open Liberty.
