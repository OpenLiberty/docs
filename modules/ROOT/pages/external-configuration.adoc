...
|Values defined as `defaultValue` in a https://openliberty.io/docs/21.0.0.2/reference/config/variable.html[<variable>] element in the Open Liberty `server.xml` file.
|1
|`server.xml`
