...
For more information, see xref:reference:microprofile-config-properties.adoc[MicroProfile Config properties].
...
- xref:reference:microprofile-config-properties.adoc[MicroProfile Config properties]
