...
Eclipse offers plug-ins that run a similar analysis on your application, which are avaialble from the https://marketplace.eclipse.org/content/ibm-websphere-application-server-migration-toolkit-was-liberty[Eclipse marketplace].
