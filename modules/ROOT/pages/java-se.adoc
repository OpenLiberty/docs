...
|24
|No
|Because Java 24 is not an LTS release, Open Liberty supports it only until the next Java version is released.
|link:https://developer.ibm.com/languages/java/semeru-runtimes/downloads/?version=24[IBM Semeru 24]
|https://adoptium.net/temurin/releases/?version=24[Eclipse Temurin 24]
|https://docs.oracle.com/en/java/javase/24/migrate/getting-started.html[Java SE 24 migration guide]
|===
