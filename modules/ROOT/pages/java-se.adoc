...
Eclipse offers plug-ins that run a similar analysis on your application. These plug-ins are available from the https://marketplace.eclipse.org/content/ibm-websphere-application-server-migration-toolkit-was-liberty[Eclipse marketplace].
