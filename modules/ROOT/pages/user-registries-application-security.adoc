...
- link:docs/latest/reference/feature/bells-1.0.adoc#_adding_a_custom_user_registry_from_a_shared_library[Adding a custom user registry from a shared library].
