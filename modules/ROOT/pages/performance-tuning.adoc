...
The Jakarta Contexts and Dependency Injection feature might be included in your server configuration because other features such as the feature:microProfile[display=MicroProfile] feature and the feature:webProfile[display=Jakarta EE Web Profile] feature include it.
