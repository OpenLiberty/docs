...
For Maven projects, specify the Liberty Maven plug-in with version `3.6.1` in your project `pom.xml` file, as shown in the following example:
...
For Gradle projects, specify the Liberty Gradle plug-in with version `3.6.1` in your project `build.gradle` file, as shown in the following example:
