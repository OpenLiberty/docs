...
You can access dev mode functions by right-clicking your project name and selecting a command from the menu. For more information, see the https://github.com/OpenLiberty/open-liberty-tools-vscode#commands[full list of commands].
