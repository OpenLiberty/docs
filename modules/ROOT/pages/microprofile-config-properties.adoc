...
The following MicroProfile Config properties can be specified when MicroProfile Telemetry is enabled. For more information, see the https://download.eclipse.org/microprofile/microprofile-telemetry-1.0-RC1/tracing/microprofile-telemetry-tracing-spec-1.0-RC1.htmll[MicroProfile Telemetry specification].
