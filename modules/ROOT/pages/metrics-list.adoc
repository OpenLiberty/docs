...
However, MicroProfile Metrics uses only a subset of those components.

The latest release of MicroProfile Metrics sources data from the following monitoring components:
-	ConnectionPool
-	ThreadPool
-	RequestTiming
-	Session
...
The superset of monitoring components also includes:
-	JVM
-	SIPContainerBasic
-	SIPContainerInboundRequests
-	SIPContainerInboundResponse
-	SIPContainerOutboundRequests
-	SIPContainerOutboundResponse
-	SIPContainerQueueMonitor
-	SIPContainerTaskDuration
