...
Some metric names changed between link:/docs/ref/feature/#mpMetrics-1.1.html[MicroProfile Metrics 1.1] and link:/docs/ref/feature/#mpMetrics.html[MicroProfile Metrics 2.x].
...
MicroProfile Metrics 2.3 explicitly enables the link:/docs/ref/feature/#monitor-1.0.html[Performance Monitoring feature].
