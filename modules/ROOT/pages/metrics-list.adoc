...
Some metric names changed between feature:mpMetrics-1.1[MicroProfile Metrics 1.1] and feature:mpMetrics[MicroProfile Metrics 2.x].
...
MicroProfile Metrics 2.3 explicitly enables the feature:monitor-1.0[Performance Monitoring feature].
