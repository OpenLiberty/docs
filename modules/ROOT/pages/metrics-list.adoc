...
Two tables list the available metrics when you use <<#metrics-table,MicroProfile Metrics 4.0 (or earlier versions)>> and <<#metrics-table-mp-metrics-5, MicroProfile Metrics 5.0>>.
