...
:page-type: general
:base-metric-features: feature:mpMetrics-3.0[]
:vendor-metric-features: feature:mpMetrics-3.0[]
:ft-metric-features: feature:mpMetrics-3.0[] and feature:mpFaultTolerance-2.1[]
