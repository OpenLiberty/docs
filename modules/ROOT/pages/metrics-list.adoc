...
For more information about building observability into your applications, see xref:microservice-observability-metrics.adoc[Microservice observability with metrics]. For information about integrating MicroProfile Metrics with Micrometer to send metric data to third-party monitoring systems, see xref:micrometer-metrics.adoc[Choose your own monitoring tools with Micrometer].
...
A separate table for for MicroProfile Metrics 5.0 is included because of changes in the release that affect the formatting of the Prometheus name, base metrics, and the metric types.
For more information, see xref:mp-50-60-diff.adoc#output[Differences between MicrProfile Metrics 5.0 and earlier versions: Metric output format].
