...
For more information about building observability into your applications, see xref:microservice-observability-metrics.adoc[Microservice observability with metrics]. For information about integrating MicroProfile Metrics 5.0 with Micrometer to send metric data to third-party monitoring systems, see xref:micrometer-metrics.adoc[Choose your own monitoring tools with MicroProfile Metrics].
...
For more information, see xref:mp-50-60-diff.adoc#output[Differences between MicroProfile Metrics 5.0 and earlier versions: Metric output format].
