...
In Open Liberty, you can use the JSON APIs by enabling either the feature:jsonp[display=JavaScript Object Notation Processing feature], for JSON-P, or the feature:jsonb[display=JavaScript Object Notation Binding feature], for JSON-B.
...
- link:hhttps://jakarta.ee/specifications/jsonb/[JSON-B specification]
