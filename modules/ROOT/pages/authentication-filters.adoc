...
* xref:reference:feature/mpJwt-1.1.adoc#_specify_login_with_microprofile_jwt_for_a_subset_of_applications_urls_browsers_or_ip_addresses[JSON Web Tokens]
* xref:reference:feature/samlWeb-2.0.adoc[SAML web]
* xref:reference:feature/spnego-1.0.adoc#_apply_spnego_authentication_to_a_subset_of_http_requests[Simple and Protected GSSAPI Negotiation Mechanism (SPNEGO)]
* xref:reference:feature/socialLogin-1.0.adoc#_request_log_in_with_a_social_media_id_for_only_a_subset_of_applications_urls_browsers_or_ip_addresses[Social Media Login]
