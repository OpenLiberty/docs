...
For more information, see xref:reference:feature/jpa.adoc[the JPA feature]. For examples of how to configure a provider implementation other than the default, see xref:reference:feature/jpaContainer.adoc[the JPA Container feature].
