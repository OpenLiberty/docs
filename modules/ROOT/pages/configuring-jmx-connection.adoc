...
----
+
In this case, you can create your own SSLContext from your own keystores and then use the SocketFactory from that context with the Opne Liberty REST connector.
