...
The trace produced by the debugging driver is limited. You can add the following option to the `jvm.options` file to ensure that all trace is produced.
[source, txt]
----
