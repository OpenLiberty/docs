...
The Derby driver does not support the `java.util.logging` library. The driver uses the `com.ibm.ws.derby.logwriter` package name in the trace specification. The following `server.xml` file example shows the configuration to enable trace for the Derby driver and specify a custom property.
...
The Microsoft SQL Server DataDirect driver does not support the `java.util.logging` library. The driver uses the `com.ibm.ws.sqlserver.logwriter` package name in the trace specification. The following `server.xml` file example shows the configuration to enable trace for the Microsoft SQL Server DataDirect driver and specify a custom property.
...
The PostreSQL driver does not support the `java.util.logging` library. The driver uses the `com.ibm.ws.postgresql.logwriter` package name in the trace specification. The following `server.xml` file example shows the configuration to enable trace for the PostreSQL driver and specify a custom property.
...
The Sybase driver does not support the `java.util.logging` library. The driver uses the `com.ibm.ws.sybase.logwriter` package name in the trace specification. The following `server.xml` file example shows the configuration to enable trace for the Sybase driver and specify a custom property.
...
Other database drivers does not support the `java.util.logging` library. The driver uses the `com.ibm.ws.database.logwriter` package name in the trace specification. The following `server.xml` file example shows the configuration to enable trace for the other database drivers and specify a custom property.
