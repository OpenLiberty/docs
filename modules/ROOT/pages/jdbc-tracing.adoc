...
You can also customize the configured trace in the `jvm.options` file using optional properties. 
...
The previous properties are optional because Liberty will use default values if they are not configured. 
