...
- `traceDirectory` : This property specifies the directory where trace is written.
- `traceFile` : This property specifies the name of the file into which trace is written.
- `traceFileAppend` : This property specifies whether to append to (`true`) or overwrite (`false`) the trace output to the specified file.
