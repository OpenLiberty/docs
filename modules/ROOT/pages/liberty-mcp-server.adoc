...
| Resources (`resources/list`, `resources/read`) | No | Not supported in this release.
| Prompts (`prompts/list`, `prompts/get`) | No | Not supported in this release.
| Sampling (`sampling/createMessage`) | No | Not supported in this release.
| Roots | No | Not supported in this release.
| Logging (`logging/setLevel`, `notifications/message`) | No | Not supported in this release.
| Completion (`completion/complete`) | No | Not supported in this release.
| Cancellation (`notifications/cancelled`) | Yes | Supported in stateful mode only.
| Progress (`notifications/progress`) | No | Not supported in this release.
| Ping (`ping`) | Yes | Fully supported.
|===
