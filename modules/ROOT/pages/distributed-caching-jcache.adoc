...
JCache is a standard Java API for caching data. Open Liberty supports the use of JCache for various application functions, including HTTP session caching and configuring a distributed authentication cache or distributed logged-out cookie cache.
