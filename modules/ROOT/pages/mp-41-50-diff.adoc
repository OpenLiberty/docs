...
MicroProfile 5.0 includes the Jakarta RESTful Web Services 3.0 feature. This version of the feature (feature:restfulWS[]) introduces changes in API behavior from the previous version (feature:jaxrs-2.1[]) that might require you to update your application code. For more information, see xref:jakarta-ee-diff.adoc#restfulws[Differences between Java Restful Services (JAX-RS) and Jakarta RESTful Web Services 3.0].
