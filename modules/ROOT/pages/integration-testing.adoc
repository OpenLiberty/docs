...
For example, you might use a local Maven build for your application in development, but the application might be deployed to a link:https://www.docker.com/why-docker[Docker] container in production.
...
With MicroShed Testing, you can write an integration test that looks like this:
