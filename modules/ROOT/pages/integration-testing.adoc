...
The `@MicroShedTest` annotation searches for a `Dockerfile` or `Containerfile` document in the repository, starts up the application in a container, and waits for the application to be ready before the test starts.
