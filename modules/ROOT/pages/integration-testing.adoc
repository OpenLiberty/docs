...
MicroShed Testing is a Java library to help you write true-to-production integration tests that test your application in an environment similar to production.
