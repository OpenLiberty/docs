...
link:https://microshed.org/microshed-testing/[MicroShed Testing] uses the link:https://www.testcontainers.org/[Testcontainers] framework to analyze your application from outside the Docker container without accessing the application internals.
