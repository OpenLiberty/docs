...
| ibm_audit_target.id | Identifier of the target of the action. | Attributes[`io.openliberty.audit.target.id`]
| ibm_audit_target.typeURI | Unique URI of the target of the event | Attributes[`io.openliberty.audit.target.type_uri`]
| ibm_audit_initiator.host.address | Host address of the initiator of the event. | Attributes["io.openliberty.audit.initiator.host.address"] Attributes["io.openliberty.type"] | ibm_audit_initiator.host.agent | Name of the monitoring agent that is associated with the initiator. | Attributes["io.openliberty.audit.initiator.host.agent"] Resource["host.name"] | ibm_audit_reason.reasonCode | A value that indicates the underlying success or error code for the outcome. In general, a value of 200 means success. | Attributes["io.openliberty.audit.reason.reason_code"] TimeStamp | ibm_audit_reason.reasonType | A value that indicates the underlying mechanism, such as HTTP or HTTPS, that is associated with the request. | Attributes["io.openliberty.audit.reason.reason_type"] Attributes["io.openliberty.sequence"] | ibm_audit_target.action | What action is being performed on the target. | Attributes["io.openliberty.audit.target.action"] Attributes["thread.id"] | ibm_audit_target.appname | Name of the application to be accessed or run on the target. | Attributes["io.openliberty.audit.target.appname"] SeverityText | ibm_audit_target.credential.token | Token name of the user that is performing the action. | Attributes["io.openliberty.audit.target.credential.token"] Body and Attributes["event"] | ibm_audit_target.credential.type | Token type of the user that is performing the action. | Attributes["io.openliberty.audit.target.credential.type"] Attributes["io.openliberty.event.sequence_number"] | ibm_audit_target.entityType | Generic name of the member that is acted upon. | Attributes["io.openliberty.audit.target.entity_type"] Attributes["io.openliberty.event.time"] | ibm_audit_target.host.address | Host and port of the target. | Attributes["io.openliberty.audit.target.host.address"] Attributes["io.openliberty.observer.id"] | ibm_audit_target.method | Method that is being invoked on the target, such as GET or POST. | Attributes["io.openliberty.audit.target.method"] Attributes["io.openliberty.observer.name"] | ibm_audit_target.name | Name of the target. | Attributes["io.openliberty.audit.target.name"] Attributes["io.openliberty.observer.type_uri"] | ibm_audit_target.realm | Realm name associated with the target. | Attributes["io.openliberty.audit.target.realm"] Attributes["io.openliberty.outcome"] | ibm_audit_target.repositoryId | Repository identifier that is associated with the target. | Attributes["io.openliberty.audit.target.repository_id"] | ibm_audit_target.session | Session identifier that is associated with the target. | Attributes["io.openliberty.audit.target.session"] Attributes["io.openliberty.target.id"] | ibm_audit_target.uniqueName | Unique name of the member that is acted upon. | Attributes["io.openliberty.audit.target.unique_name"] Attributes["io.openliberty.target.type_uri"]
|======================================
