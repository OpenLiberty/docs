...
* The elapsed time of the request in milliseconds (end-to-end including client and network time)
* The elapsed time until the first bytes of the response are sent in milliseconds (a close approximation of application response time)
