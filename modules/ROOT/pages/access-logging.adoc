...
* The elapsed time until the first bytes of the response are sent in microseconds. This value is often a close approximation of application response time.
