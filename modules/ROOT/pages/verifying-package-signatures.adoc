...
3. Extract the public key  as a `.pem` file from the `.cer` file.
+
...
1. Run the following command to download the public key file. The key ID value for the Open Liberty public key is `9E68CA00`.
+
[source,sh]
----
