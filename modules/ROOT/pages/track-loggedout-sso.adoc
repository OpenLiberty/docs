...
<cache id="io.openliberty.cache.loggedoutcooki" name="io.openliberty.cache.loggedoutcooki"
    cacheManagerRef="CacheManager" />

<webAppSecurity loggedOutCookieCacheRef="io.openliberty.cache.loggedoutcooki" />
----
...
----
<infinispan>
    <distributed-cache name="io.openliberty.cache.loggedoutcooki"">
...
----
<hazelcast>
     <cache name="io.openliberty.cache.loggedoutcooki">
