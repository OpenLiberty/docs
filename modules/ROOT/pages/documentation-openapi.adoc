...
The following table lists xref:external-configuration.adoc[MicroProfile Config] properties that can be specified in your `microprofile-config.properties` file to configure which modules or applications are included in the generated OpenAPI documentation.
