...
Additionally, you can generate the stubs, which are testable versions of modules, to test your source code from this manually created documentation, including client libraries for the API.
...
To see the documentation in the UI of the application, use a browser to go to the `/openapi/ui` endpoint.
