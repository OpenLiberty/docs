...
You can augment the documentation with annotations in the code as described.
...
With https://openliberty.io/guides/microprofile-openapi.html#filtering-the-openapi-tree-elements[filters], you can implement an interface in your application.
...
You can view the documentation by pointing a browser at the `/openapi/ui` https://Liberty_host:https_port/openapi/ui[endpoint].

Some deprecated annotations were removed between 1.1 and 2.0 resulting in potential breaking changes.
For more information, see https://download.eclipse.org/microprofile/microprofile-open-api-2.0/microprofile-openapi-spec-2.0.html#release_notes_20[Release Notes for Microprofile OpenAPI 2.0]
