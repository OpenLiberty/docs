...
If you want to update or remove certain elements and fields of the OpenAPI document you can use a filter, which is called once after all other documentation mechanisms have completed. .
