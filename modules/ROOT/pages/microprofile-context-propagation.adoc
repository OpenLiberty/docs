...
As for Jakarta feature:concurrent[display=Concurrency 3.0], the functionality and API of Microprofile Context Propagation relating to completion stages are adopted into the Jakarta programming model. It is available on the https://jakarta.ee/specifications/concurrency/3.0/apidocs/jakarta/enterprise/concurrent/ManagedExecutorService.html[ManagedExecutorService] and https://jakarta.ee/specifications/concurrency/3.0/apidocs/jakarta/enterprise/concurrent/ContextService.html[ContextService] interfaces.
