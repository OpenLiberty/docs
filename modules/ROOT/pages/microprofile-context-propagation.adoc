...
* With MicroProfile Context Propagation, you can also configure and inject instances by way of CDI, as shown in the following example. Injecting instances by CDI requires the config:cdi12[display=Contexts and Dependency Injection] feature, version 2.0 or later.
+
