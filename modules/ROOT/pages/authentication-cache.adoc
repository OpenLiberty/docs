...
The authentication cache is available by default when the feature:appSecurity[Application Security (Jakarta Security)] feature is enabled in your `server.xml` file.
