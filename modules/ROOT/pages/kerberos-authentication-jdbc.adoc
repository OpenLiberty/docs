...
https://docs.oracle.com/en/database/oracle/oracle-database/21/jjdbc/JDBC-Thin-features.html#GUID-003FC8A9-9CD7-41C4-AD73-BE6F5D13D1DB[The Oracle JDBC thin driver] supports only the Oracle JDK or OpenJDK kerberos implementations. If you are using the Oracle JDBC thin driver, you cannot authenticate via Kerberos with the https://www.ibm.com/support/knowledgecenter/SSYKE2_8.0.0/welcome/welcome_javasdk_version.html[IBM SDK, Java Technology Edition, Version 8].
