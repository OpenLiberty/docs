...
You can optionally create a Hazelcast configuration file, as shown in the following example, and add a reference to the Hazelcast configuration file in your `server.xml` file:
