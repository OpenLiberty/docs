...
You can optionally create a Hazelcast configuration file, as shown in the following example, and add a reference to the xref:reference:feature/sessionCache-1.0.adoc#_providing_additional_hazelcast_configuration[Hazelcast configuration file] in your `server.xml` file:
