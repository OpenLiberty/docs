...
== See also
- xref:mp-22-30-diff.adoc#ft[Differences between MicroProfile Fault Tolerance 1.1 and 2.0]
- xref:mp-33-40-diff.adoc#ft[Differences between MicroProfile Fault Tolerance 2.1 and 3.0]
