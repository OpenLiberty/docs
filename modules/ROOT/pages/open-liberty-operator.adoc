...
When you deploy an application with the https://github.com/OpenLiberty/open-liberty-operator/blob/master/doc/user-guide.adoc#open-liberty-operator[Open Liberty Operator], the operator watches Open Liberty resources and compares the current state of resources to the state of resources that you configure.
...
For more information, see the Open Liberty Operator documentation.
