...
A WebSphere Liberty image includes the `liberty.version` label and the `com.ibm.websphere.liberty.version` label that specifies the Liberty version of the image.
...
----
        "com.ibm.websphere.liberty.version": "<liberty-version>",
