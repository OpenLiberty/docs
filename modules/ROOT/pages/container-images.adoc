...
An Open Liberty image includes the `liberty.version` label and the `com.ibm.openliberty.version` label that specifies the Liberty version of the image.
...
----
        "com.ibm.openliberty.version": "<liberty-version>",
