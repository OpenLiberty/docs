...
You can append an Open Liberty container image tag to the `icr.io/appcafe/open-liberty:` source to specify the details of the container image that you pull from ICR. For more information, see <<#build, Build an application image>>
...
For more information about these tag values, see <<#tags,Container image tags naming conventions>>.
