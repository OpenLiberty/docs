...
You need to enable the Password Utilities feature in the server.xml file to include authentication in your CDI producer.
...
```
To connect over TLS, https://openliberty.io/docs/21.0.0.8/reference/feature/transportSecurity-1.0.html#_configure_transport_layer_security_tls[configure TLS for your Open Liberty server].
