...
You can access a NoSQL database with a Contexts and Dependency Injection (CDI) producer in Open Liberty, without enabling features like MongoDB or CouchDB.

Before Open Liberty version 19.0.0.6, using MongoDB or Couch DB databases required you to enable the MongoDB or CouchDB feature.
