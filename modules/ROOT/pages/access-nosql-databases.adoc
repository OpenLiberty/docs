...
Before Open Liberty 19.0.0.6, only certain versions of NoSQL databases were available, and these required you to enable specific features in your `server.xml` file.
