...
Although the examples in the following sections use an example JAR application file, the for the optimized Spring Boot deployment is the same for JAR and WAR files.
