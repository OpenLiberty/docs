...
+
- If your application uses Spring Boot 1.x.x+ (including versions such as 1.5.22 in the 1.x.x stream), enable the feature:springBoot-1.5[] feature.
- If your application uses Spring Boot 2.x.x+ (including versions such as 2.7.18 in the 2.x.x stream), enable the feature:springBoot-2.0[] feature.
- If your application uses Spring Boot 3.x.x+ (including versions such as 3.5.6 in the 3.x.x stream), enable the feature:springBoot-3.0[] feature.
- If your application uses Spring Boot 4.x.x+ (including versions such as 4.0.5 in the 4.x.x stream), enable the feature:springBoot-4.0[] feature.
+
