...
Open Liberty supports both the PKIX and `SunX509` algorithms. For better security, use PKIX, as it provides enhanced certificate validation based on modern industry standards.
