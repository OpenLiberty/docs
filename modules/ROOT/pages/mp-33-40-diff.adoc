...
:page-type: general
= Differences between MicroProfile 3.3 and 4.0
...
- <<#ft,Differences between MicroProfile Fault Tolerance 2.1 and 3.0>>
- <<#config,Differences between MicroProfile Config 1.4 and 2.0>>
...
[#config]
== Differences between MicroProfile Config 1.4 and 2.0
