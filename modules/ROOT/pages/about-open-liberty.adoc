...
After deployment, the feature:appSecurity[Application Security feature] provides the core capability for the Jakarta EE Security API, while the feature:transportSecurity[Transport Security feature] enables secure TLS connections by using HTTPS.
