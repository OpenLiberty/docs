...
Consider these definitions when you install Open Liberty and its available features. Each installation option provides the Open Liberty kernel and features that support the full platform or Web Profile. You can install the Open Liberty kernel with the full platform or just the Web Profile features. Alternatively, you can install individual Jakarta EE features to your existing Open Liberty kernel installation.
