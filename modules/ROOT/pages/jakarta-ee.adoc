...
The following diagram shows the relationship between the components of the Jakarta EE platform. An Open Liberty server supports cloud-native applications by implementing the functions that these components specify.
