...
The `Djgroups.dns.query` option specifies the DNS record that returns all of the members of the Infinispan cluster. If the environment doesn't support the IPv6 protocol, then you can set the `Djava.net.preferIPv4Stack` option to `"true"`.
