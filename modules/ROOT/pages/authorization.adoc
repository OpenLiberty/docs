...
- link:https://docs.oracle.com/javaee/7/tutorial/security-webtier002.htm[Java Platform, Enterprise Edition (Java EE) 7 - Securing web applications]
- link:https://javaee.github.io/tutorial/security-webtier002.html[Java Platform, Enterprise Edition (Java EE) 8 - Securing web applications]
- link:https://jakarta.ee/learn/docs/jakartaee-tutorial/current/security/security-webtier/security-webtier.html[Getting Started Securing Web Applications]
