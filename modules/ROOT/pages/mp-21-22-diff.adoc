...
The following table lists the feature:mpMetrics-2.2[display=MicroProfile Metrics 2.2] metric names and the corresponding feature:mpMetrics-1.1[display=MicroProfile Metrics 1.1] metric names. It also lists the corresponding Prometheus names and metric types for each MicroProfile Metrics version:
{empty} +
