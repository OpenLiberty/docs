...
The Performance Monitoring feature https://docs.oracle.com/javase/tutorial/jmx/mbeans/mxbeans.html[provides JMX MXBeans] that you can use with monitoring tools that use JMX, such as JConsole.
...
You can also choose to use other products that consume JMX metrics to view your metrics information.
