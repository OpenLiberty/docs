...
The JNoSQL Jakarta Persistence extension is not required because the Open Liberty Jakarta Data provider and JNoSQL Jakarta Data provider can be used simultaneously.
