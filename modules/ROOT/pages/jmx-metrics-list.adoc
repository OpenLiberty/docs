...
The object name of the MXBean for these attributes is `WebSphere:type=McpOperationStatistics,name=*`:
...
The object name of the MXBean for these attributes is `WebSphere:type=McpSessionStatistics,name=*`:
