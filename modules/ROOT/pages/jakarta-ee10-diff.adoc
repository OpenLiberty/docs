...
Open Liberty applications that use the `jakartaee-10.0` convenience feature and require the Admin Rest Connector function must include the `restConnector-2.0` feature to the `server.xml` file.
