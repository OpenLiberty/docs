...
- MyFaces updated its JavaScript implementation to the newer ECMAScript 2015 (ES6) standard.  As a result, older browsers, such a Internet Explorer, do not support the newer syntax.  Automation tools for testing, such as HTMLUnit, also might encounter errors. 
