...
- feature:webProfile-10[display=Jakarta EE Web Profile 10.0] (`webProfile-10`) 
...
If you see the following error message in your logs, you need to add the io.openliberty.globalhandler-1.0 feature to your user feature manifest file.
...
For more information, see the link:https://jakarta.ee/specifications/security/3.0/apidocs/jakarta.security/module-summary.html[Jakarta Security 3.0 Javadoc] and [LINK TO FORTHCOMING ODIC DOC].
